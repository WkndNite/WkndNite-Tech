---
title: 关于 Docker 的那点破事儿
description: 关于 Docker 的那点破事儿
sidebar:
    order: 1
---
...
这一部分在上一节已经提到过了，忘记的可以回过头看一眼 [Docker 底层技术](/docker/preview/#docker底层技术)。
![Docker 底层技术](https://docs.docker.com/get-started/images/docker-architecture.webp)

## Docker 环境搭建

![Docker 环境搭建](@src/assets/docker/docker-env-setup.excalidraw.png)
